            ...
            {"units":
             [{UNIT_NAME_KEY: unit, UNIT_WIDTH_KEY: 1, UNIT_CAPS_KEY: ["ALU"],
               **{attr: True for attr in [UNIT_RLOCK_KEY, UNIT_WLOCK_KEY]},
               UNIT_MEM_KEY: ["alu"]}], "dataPath": []}) == ProcessorDesc(
                   [], [],
...
class TestMemAclCase:
    ...
    def test_capability_case_is_checked_in_core0(self, caplog):
        ...
        assert load_proc_desc({
            "units":
            [{UNIT_NAME_KEY: "core 0", UNIT_WIDTH_KEY: 1,
              UNIT_CAPS_KEY: ["ALU"],
              **{attr: True for attr in [UNIT_RLOCK_KEY, UNIT_WLOCK_KEY]}},
            ...
            "dataPath": []}) == ProcessorDesc(
                [], [], [UnitModel(ICaseString("core 0"), 1, [
        ...
        for token in ["alu", "core 2", "ALU", "core 0"]:
            assert token in warn_msg

    def test_capability_case_is_checked_in_core1(self, caplog):
        """Test ACL capability cases are checked across all units.
